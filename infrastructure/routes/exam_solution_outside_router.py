...
@router.get("/", response_model=CorrectorExamSolutionList, status_code=200)
async def get_all_exam_solutions_by_corrector_id(
    ...
    auth_service.check_api_key(apikey)
    return ExamSolutionController.get_all_exam_solutions_by_corrector_id(db, corrector_id)
...
async def get_all_exam_solutions_by_course_id(
    ...
    auth_service.check_api_key(apikey)
    return ExamSolutionController.get_all_exam_solutions_by_course_id(db, course_id)
