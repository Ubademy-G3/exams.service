...
get_all_by_course_id_body = None

result_from_get_all_by_course_id = []

result_from_get_all_by_course_id.append(
    ExamTemplate(
        id="5122b737-f815-4e15-a56d-abbff2fee900",
        course_id="2f120281-12cd-413f-8e6a-2678b6b92406",
        creator_id="f1e8ea4b-3909-4f66-80ca-aad491049bdf",
...
class GetAllExamTemplatesByCourseIdMock(TestCase):
    ...
    def test_create_exam_template(self, mock_method):
        ...
        assert data["exam_templates"][0]["course_id"] == course_id
